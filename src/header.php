...
<body data-post="<?php echo $post->post_name ?>" data-directory="<?php echo $template_directory ?>"> <?php
  wp_body_open() ?>
  <noscript>
  ...
  <header class="hdr container"> <?php
    ...
    <div class="hdr__buttons">
      <button type="button" class="hdr__callback">
        <svg class="hdr__callback-img">
          <use xlink:href="<?php echo $template_directory . '/img/icons-sprite.svg#icon-callback' ?>"></use>
        </svg>
        <span class="hdr__callback-text">Заказать обратный звонок</span>
      </button>
      <a href="<?php echo $whatsapp ?>" class="hdr__whatsapp">
        <svg class="hdr__whatsapp-img">
          <use xlink:href="<?php echo $template_directory . '/img/icons-sprite.svg#icon-whatsapp' ?>"></use>
        </svg>
        <span class="hdr__whatsapp-text">Задать вопрос в WhatsApp</span>
      </a>
    </div>
    <div class="hdr__contacts">
      ...
      <div class="address hdr__address"><?php echo $address ?></div>
